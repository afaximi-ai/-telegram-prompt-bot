...
async def send_prompt_result(
    ...
    # اگر پرامپت تا 256 کاراکتر باشد
...
async def generate_prompt_from_photo(
    ...
    # فقط اگر کاربر در حالت ساخت پرامپت باشد
...
async def receive_prompt(
    ...
    # =================================================
    # ارسال عکس‌ها به کانال
    #
    # عکس اول:
    #   کپشن = Prompt Realistic ✨
    #   دکمه دریافت پرامپت
    #
    # عکس‌های بعدی:
    #   بدون کپشن
